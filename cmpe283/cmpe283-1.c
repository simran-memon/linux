 ...
 * See SDM volume 3C, section 23.6.1 Table 23-5. Definitons of Pin-based VM-Execution Controls
*/
 ...
 * SDM Volume 3C, section 23.6.2 Table 23-6. Definitons of Primary processor-Based VM-Execution Controls 
*/
 ...
 * SDM Volume 3C, section 23.6.2 Table 23-7. Definitons of Secondary Processor-Based VM-Execution Controls
*/
 ...
 * SDM Volume 3C, section 23.7.1 Table 23-12. Definitons of VM-Exit Control
*/

struct capability_info vm_exit_control[14] =
{
 ...
 * SDM Volume 3C, section 23.8.1 Table 23-14. Definitions of VM-Entry Controls
*/

struct capability_info vm_entry_control[12] =
{
...
detect_vmx_features(void)
{
	...
	rdmsr(IA32_VMX_EXIT_CTLS, lo, hi);
        ...
        (uint64_t)(lo | (uint64_t)hi << 32));
        report_capability(vm_exit_control, 14, lo, hi);

	/* VM-Entry Control Fields */
	rdmsr(IA32_VMX_ENTRY_CTLS, lo, hi);
        pr_info("VM-Entry Controls MSR: 0x%llx\n",
        (uint64_t)(lo | (uint64_t)hi << 32));
        report_capability(vm_entry_control, 12, lo, hi);
